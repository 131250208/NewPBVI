...
public class LinkedList<V> implements List<V>,Serializable {
	...
	public void add(int idx, V vData ) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.add(int idx, V vData )");
	}
	...
	public boolean addAll(int arg0, Collection arg1) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.addAll(int arg0, Collection arg1)");
		return false;
	}
	...
	public boolean containsAll(Collection arg0) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.containsAll(Collection arg0) ");
		return false;
	}
	...
	public int indexOf( Object arg0 ) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.indexOf( Object arg0 )");
		return m_cElements;
	}
	...
	public int lastIndexOf(Object arg0) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.lastIndexOf(Object arg0)");
		return m_cElements;
	}

	@Override
	public ListIterator<V> listIterator() {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.listIterator()");
		return null;
	}

	@Override
	public ListIterator<V> listIterator(int arg0) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.listIterator(int arg0)");
		return null;
	}
	...
	public V remove(int idx) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.remove(int idx)");
		return null;
	}
	...
	public boolean removeAll(Collection c) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.removeAll(Collection c)");
		return false;
	...
	public boolean retainAll(Collection c) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.retainAll(Collection c)");
		return false;
	}

	@Override
	public V set(int arg0, Object arg1) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.set(int arg0, Object arg1)");
		return null;
	}
	...
	public List subList(int arg0, int arg1) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.subList()");
		return null;
	}

	@Override
	public Object[] toArray() {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.toArray()");
		return null;
	}
	...
	public V[] toArray(Object[] arg0) {
		System.out.println("调用了未实现的方法pomdp.datastructures.LinkedList.toArray(Object[] arg0)");
		return null;
	}
